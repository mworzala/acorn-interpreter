...
val Type.Companion.empty get() = TupleType(listOf())
...
class SelfType : Type() {
    ...
    override fun default(context: Context) = throw RuntimeException("self type has no default value")
...
class ArrayType(
    ...
    override fun default(context: Context) = ArrayValue(context, this, listOf())
...
class StructType(
    ...
    val memberDefaults: List<Value?>,
    override val isMut: Boolean = false,
) : Type() {

    override fun asMut() = StructType(name, memberNames, memberTypes, memberDefaults, true)
    ...
    override fun hashCode() = Objects.hash(memberNames, memberTypes)
}
