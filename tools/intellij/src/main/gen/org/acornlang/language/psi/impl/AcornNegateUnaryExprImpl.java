...
public class AcornNegateUnaryExprImpl extends AcornExprImpl implements AcornNegateUnaryExpr {

  public AcornNegateUnaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AcornVisitor visitor) {
    visitor.visitNegateUnaryExpr(this);
  }
