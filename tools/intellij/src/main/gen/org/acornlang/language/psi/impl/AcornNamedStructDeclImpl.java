...
public class AcornNamedStructDeclImpl extends AcornContainerItemImpl implements AcornNamedStructDecl {

  public AcornNamedStructDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AcornVisitor visitor) {
    visitor.visitNamedStructDecl(this);
  }
