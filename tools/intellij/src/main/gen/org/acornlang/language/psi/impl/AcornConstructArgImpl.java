...
public class AcornConstructArgImpl extends ASTWrapperPsiElement implements AcornConstructArg {

  public AcornConstructArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AcornVisitor visitor) {
    visitor.visitConstructArg(this);
  }
