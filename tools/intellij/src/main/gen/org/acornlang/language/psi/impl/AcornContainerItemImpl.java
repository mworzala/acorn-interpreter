...
public class AcornContainerItemImpl extends ASTWrapperPsiElement implements AcornContainerItem {

  public AcornContainerItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AcornVisitor visitor) {
    visitor.visitContainerItem(this);
  }
