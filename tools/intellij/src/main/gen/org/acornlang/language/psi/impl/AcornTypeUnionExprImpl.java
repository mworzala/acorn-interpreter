...
public class AcornTypeUnionExprImpl extends AcornExprImpl implements AcornTypeUnionExpr {

  public AcornTypeUnionExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AcornVisitor visitor) {
    visitor.visitTypeUnionExpr(this);
  }
