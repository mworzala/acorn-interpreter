...
public class AcornParenOrTupleExprImpl extends AcornExprImpl implements AcornParenOrTupleExpr {

  public AcornParenOrTupleExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AcornVisitor visitor) {
    visitor.visitParenOrTupleExpr(this);
  }
